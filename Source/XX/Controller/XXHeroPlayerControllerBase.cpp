...
#include "XXHeroPlayerControllerBase.h"
...
AXXHeroPlayerControllerBase::AXXHeroPlayerControllerBase()
{
	bReplicates = true;
}

void AXXHeroPlayerControllerBase::BeginPlay()
{
	Super::BeginPlay();
...
void AXXHeroPlayerControllerBase::Server_SpawnHeroCharacter_Implementation(UClass* InClass)
{
